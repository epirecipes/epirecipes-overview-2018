...
- Complete assimilation of examples from the workshop
- More examples!
- First release of the cookbook
- Future hackathons
- Engineering
    - More interfaces (RStudio, Iodide, Shiny, Stencila)
...
- Many examples in R
- Ottar kindly sent me the source code for the book
- Integration of the examples is currently underway
...
- Iodide
    - Another web notebook like Observable
    - Supports Javascript, Python, etc.
    - Fully open source
- Stencila
    - Word-processor style
    - Supports R, Python, Javascript, SQL

## Further support

- Long-listed for another workshop funded by The Alan Turing Institute
- May apply for ICMS on a more research-focused activity: cutting-edge models?
- Wellcome Open Science Prize

## Analysing case onset data

- Infectious disease data are increasingly published online as 'situation reports' or 'sitreps', which include case onset data, aggregated by time period, and sometimes spatial region and/or population subgroup
- Thibaut Jombart (Imperial/LSHTM) and I set up a repository of these data, `outbreaks`
- There are *many* methods to analyse these data, but...
    - They have not been tested against a variety of datasets
    - Implementations are scattered on the WWW
    - Documentation/examples are often lacking

## Conclusions

- After only a single hackathon, Epirecipes already contains a wide range of models in a variety of languages
- Easily deployable platform for reproducible simulation of biological systems
- Much to be done!
